...
<template>
  <button
    class="focus-ring flex min-h-[104px] flex-col items-stretch gap-1 border-b border-r border-border p-1.5 text-left transition-colors hover:bg-surface-raised"
  ...
  >
    ...
    <span class="flex min-h-0 flex-1 flex-col gap-1">
      <span
        v-for="row in visibleRows"
        :key="row.taskId"
        class="flex items-center gap-1 rounded-[5px] px-1.5 py-[3px]"
